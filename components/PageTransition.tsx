            ...
            <div className="sticky top-0 z-50 bg-dark-900/95 backdrop-blur-xl border-b border-dark-700">
              <div className="flex items-center justify-between p-4 lg:p-6">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    onClick={handleClose}
                    className="w-10 h-10 bg-dark-700 hover:bg-red-500 rounded-full flex items-center justify-center text-gray-400 hover:text-white transition-all duration-300"
                  >
                    <X className="w-5 h-5" />
                  </button>
                </div>
