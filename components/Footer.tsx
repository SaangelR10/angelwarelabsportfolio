            ...
            <div className="flex space-x-4">
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.9 }}
                  className="w-10 h-10 bg-dark-800 border border-dark-600 rounded-lg flex items-center justify-center hover:bg-primary-500 hover:border-primary-500 transition-all duration-300"
                >
              ...
              {quickLinks.map((link, index) => (
                ...
                >
                  <button
                    ...
                    className="text-gray-400 hover:text-primary-400 transition-colors duration-300 hover:translate-x-1 transition-transform duration-300"
                  >
                    {link.name}
                  </button>
                </motion.li>
