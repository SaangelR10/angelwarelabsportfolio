      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            {/* Footer */}
            <div className="sticky bottom-0 bg-dark-800/95 border-t border-dark-700 p-4 sm:p-6">
              <div className="flex space-x-3">
                ...
                <button className="flex-1 bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white py-3 px-4 rounded-lg transition-all font-medium flex items-center justify-center space-x-2">
                  <span>Contactar</span>
